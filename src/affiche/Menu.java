...
public void etudiant(){
    ...
    switch(choice)
    {
        case 1:
            ...
            int nom= clavier.nextInt();
            System.out.println("Veillez saisir le prenom de l'etudiant");
            int prenom= clavier.nextInt();
            System.out.println("Veillez saisir l'eamail de l'etudiant");
            int email= clavier.nextInt();
            ...
            Etudiant e = new Etudiant(id,nom,prenom,email,matricule,dateDeNaissances,telephone,adresse);
